...
2015 \quad \= International Society for Magnetic Resonance in Medicine: \\
		...
		2013 \quad \= $2^{{nd}}$ place ISMRM reconstrution challenge 2013 \\
\end{tabbing}
...
%\vspace{0.2cm}
\begin{tabbing}
	\textbf{AVIONIC} \=  \href{http://github.com/imttugraz/avionic}{Accelerated Variational dynamic MRI reconstruction.} \\
\end{tabbing}
\bigskip
